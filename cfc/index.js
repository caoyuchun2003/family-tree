...
const PUBLIC_PEOPLE = [
  ...
  { id: 'cao-jiuzhong', name: '曹九重', generation: 4, branch: '九字辈·待核', gender: '男', years: '待考', location: '山西省朔州市应县南河种镇小石口村', status: '待确认', note: '姓名和父子连线来自第一张放大图，字形及归属房支待家人复核。', parentIds: ['cao-yushan'] },
  { id: 'cao-jiuxu-shu', name: '曹九续', generation: 4, branch: '九字辈·待核', gender: '男', years: '待考', location: '山西省朔州市应县南河种镇小石口村', status: '待确认', note: '姓名和父子连线来自第一张放大图，字形及归属房支待家人复核。', parentIds: ['cao-yushan'] },
  { id: 'cao-jiugong', name: '曹九工', generation: 4, branch: '九字辈·待核', gender: '男', years: '待考', location: '山西省朔州市应县南河种镇小石口村', status: '待确认', note: '姓名和父子连线来自第一张放大图，字形及归属房支待家人复核。', parentIds: ['cao-haoshan'] },
  { id: 'cao-jiuguan', name: '曹九官', generation: 4, branch: '九字辈·待核', gender: '男', years: '待考', location: '山西省朔州市应县南河种镇小石口村', status: '待确认', note: '姓名和父子连线来自第一张放大图，字形及归属房支待家人复核。', parentIds: ['cao-wangshan'] },
  { id: 'cao-jiuyin', name: '曹九银', generation: 4, branch: '九字辈·待核', gender: '男', years: '待考', location: '山西省朔州市应县南河种镇小石口村', status: '待确认', note: '姓名和父子连线来自第一张放大图，字形及归属房支待家人复核。', parentIds: ['cao-wangshan'] },
  { id: 'cao-jiucheng', name: '曹九城', generation: 4, branch: '九字辈·待核', gender: '男', years: '待考', location: '山西省朔州市应县南河种镇小石口村', status: '待确认', note: '姓名和父子连线来自第一张放大图，字形及归属房支待家人复核。', parentIds: ['cao-wangshan'] },
